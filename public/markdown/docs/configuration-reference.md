...
| --------------------- | -------------- | ------------| ----------------------------------------------------------------------------------------------------------- |
| `name`                | string         | Conditional | Application name. (see [Container Name Source](#container-name-source))                                     |
| `preset`              | string         | No          | Apply preset configuration (Options: database, service)  (see [Presets](#presets))                          |
| `protected`           | boolean        | No          | Exclude from `--all` deployments (default: false)  (see [Protected Targets](#protected-targets))            |
| `naming_strategy`     | string         | No          | Container naming: "dynamiAc" (default) or "static" (see [Naming Strategy](#naming-strategy))                |
