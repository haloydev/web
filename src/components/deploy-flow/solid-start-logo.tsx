export function SolidStartLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 166 155.3" className={className}>
      <defs>
        <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="27.028" x2="151.542" y1="3.451" y2="63.891">
          <stop offset=".118" stopColor="#bbbdbf" />
          <stop offset=".299" stopColor="#f1f1f2" />
          <stop offset="1" stopColor="#d0d2d3" />
        </linearGradient>
        <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="95.307" x2="73.509" y1="32.988" y2="105.648">
          <stop offset="0" stopColor="#bbbdbf" />
          <stop offset=".475" stopColor="#929497" />
          <stop offset="1" stopColor="#58595b" />
        </linearGradient>
        <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="17.932" x2="143.767" y1="64.628" y2="150.169">
          <stop offset="0" stopColor="#58595b" />
          <stop offset=".539" stopColor="#929497" />
          <stop offset="1" stopColor="#58595b" />
        </linearGradient>
        <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="74.763" x2="23.901" y1="74.909" y2="261.184">
