...
Haloy's server daemon includes a built-in reverse proxy with automatic Let's Encrypt certificate provisioning. Point your DNS at the server, set your `domains` in config, and HTTPS works on the first deploy. No extra components needed.
