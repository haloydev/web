...
Stream platform-level operational logs from the haloyd server daemon in real-time. These are internal logs showing deployments, health checks, proxy routing, etc.
