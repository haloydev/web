...
image:
  ...
  registry:
    ...
    password:
      from:
        env: "REGISTRY_PASSWORD"`} lang="yaml" />

Then set the environment variables:

<Code code={`export REGISTRY_USERNAME="your-username"
...
<Code code={`image:
  ...
  registry:
    ...
    password:
      value: "ghp_your_personal_access_token"`} lang="yaml" />
...
<Code code={`image:
  ...
  registry:
    ...
    password:
      value: "your-dockerhub-token"`} lang="yaml" />
...
domains:
  - domain: "my-app.com"
acme_email: "you@email.com"`} lang="yaml" />
...
acme_email: "admin@production-app.com"`} lang="yaml" />
