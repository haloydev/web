...
section: deployment
description: 'Choose between rolling deployments for zero-downtime updates and replace deployments for simpler cutover. Configure health checks and timeouts.'
---
