...
<Code code={`name: "high-availability-app"
...
domains:
  - domain: "ha-app.com"
acme_email: "admin@ha-app.com"`} lang="yaml" />
...
<Code code={`name: "batch-processor"
deployment_strategy: "replace"
replicas: 2
...
targets:
  ...
  development:
    ...
    replicas: 1
    domains:
      - domain: "dev.my-app.com"`} lang="yaml" />
...
**Go:**
<Code code={`func healthHandler(w http.ResponseWriter, r *http.Request) {
    // Check database
