...
<Code code={`name: "my-scalable-app"
image:
...
<Code code={`Internet → HAProxy (80/443) → Container 1 (8080)
                        → Container 2 (8080)
                        → Container 3 (8080)`} lang="bash" />
...
acme_email: "admin@critical-app.com"`} lang="yaml" />
