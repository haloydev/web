...
[github.com/haloydev/examples/tanstack-start-sqlite](https://github.com/haloydev/examples/tree/main/tanstack-start-sqlite)

## Why This Stack?

**TanStack Start**  File-based routing, server functions, and TypeScript support out of the box

**SQLite**  Zero-config database that handles millions of requests per day on a single server

**Haloy**  Deploy to your own infrastructure without Kubernetes complexity or PaaS costs
