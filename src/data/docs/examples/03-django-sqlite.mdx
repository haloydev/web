...
[github.com/haloydev/examples/django](https://github.com/haloydev/examples/django)
...
`} lang="text" />
  ...
  **Note:** If you plan to add this project to a git repository it would also be beneficial with a `.gitignore` file. Check out the [source code](https://github.com/haloydev/examples/django) for an example.
