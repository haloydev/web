...
description: 'Install the Haloy CLI on macOS, Linux, or Windows. Available via Homebrew, npm, curl script, or direct binary download.'
---
...
To install the latest version via Go CLI:

<Code code="go install github.com/haloydev/haloy/cmd/haloy@latest" lang="bash" />
