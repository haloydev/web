...
description: 'Add Haloy to an existing Docker project. Create a haloy.yaml config and deploy your application to your own server.'
---
...
For aliases, HTTPS behavior, and multi-target domain examples, see [Domain Configuration](/docs/domain-configuration).
