...
section: guides
description: 'Manage multiple Haloy servers and API tokens. Add, switch between, and configure authentication for your deployment servers.'
---
...
3. **Environment variable**: `HALOY_API_TOKEN` environment variable (useful for [CI/CD](/docs/github-actions))
