...
- **haloy** (default): Application containers connect to this network and can reach each other by container name. Internal services without domains use static naming and the `replace` strategy so that name stays fixed
